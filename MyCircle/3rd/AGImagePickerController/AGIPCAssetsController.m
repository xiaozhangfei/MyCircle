...
- (void)viewDidLoad
{
    ...
    BtnExt *btn = [[BtnExt alloc] initWithFrame:CGRectMake(5, 20, 84, 44)];
    ...
    btn.btnType = XFBtnTypeRight;
    btn.imageSize = CGSizeMake(25, 25);
    btn.imageToBorderOffset = 0;
    btn.titleLabel.font = [UIFont systemFontOfSize:15.0f];
    self.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc] initWithCustomView:btn];
}

- (void)btnAction:(BtnExt *)sender {
...
- (void)setupToolbarItems
{
    if (self.imagePickerController.toolbarItemsForManagingTheSelection != nil)
    {
        ...
        UIBarButtonItem *selectAll = [[UIBarButtonItem alloc] initWithTitle:@"全选" style:UIBarButtonItemStyleBordered target:self action:@selector(selectAllAction:)];
        UIBarButtonItem *flexibleSpace = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemFlexibleSpace target:nil action:nil];
        UIBarButtonItem *deselectAll = [[UIBarButtonItem alloc] initWithTitle:@"取消全选" style:UIBarButtonItemStyleBordered target:self action:@selector(deselectAllAction:)];

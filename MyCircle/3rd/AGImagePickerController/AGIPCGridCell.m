...
- (void)layoutSubviews
{
	...
	for (AGIPCGridItem *gridItem in self.items)
    {
        ...
        gridItem.checkmarkImageView.userInteractionEnabled = YES;
		[gridItem.checkmarkImageView addGestureRecognizer:selectionGestureRecognizer];
        
        UITapGestureRecognizer *zoneGestureRecognizer = [[UITapGestureRecognizer alloc] initWithTarget:gridItem action:@selector(zoneImageAction)];
        zoneGestureRecognizer.numberOfTapsRequired = 1;
        gridItem.thumbnailImageView.userInteractionEnabled = YES;
        [gridItem.thumbnailImageView addGestureRecognizer:zoneGestureRecognizer];

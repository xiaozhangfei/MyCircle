...
- (void)initView {
    ...
    _backImV.layer.cornerRadius = SCREEN_ORIGINWIDTH_5(10);
    ...
    _photoImv.layer.cornerRadius = SCREEN_ORIGINWIDTH_5(40);
    ...
    [_backImV mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo (weakSelf.contentView.mas_top).with.offset (SCREEN_ORIGINWIDTH_5(10));
        make.left.equalTo (weakSelf.contentView.mas_left).with.offset (SCREEN_ORIGINWIDTH_5(10));
        make.right.equalTo (weakSelf.contentView.mas_right).with.offset (SCREEN_ORIGINWIDTH_5(-10));
        make.bottom.equalTo (weakSelf.contentView.mas_bottom).with.offset (SCREEN_ORIGINWIDTH_5(-10));
    }];
    
    [_titleLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo (weakSelf.backImV.mas_top).with.offset (SCREEN_ORIGINWIDTH_5(10));
        make.left.equalTo (weakSelf.backImV.mas_left).with.offset (SCREEN_ORIGINWIDTH_5(10));
        make.right.equalTo (weakSelf.backImV.mas_right).with.offset (SCREEN_ORIGINWIDTH_5(-10));
        make.height.offset (SCREEN_ORIGINWIDTH_5(40));
    }];
    
    [_introLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.equalTo (weakSelf.titleLabel.mas_left).with.offset (0);
        make.top.equalTo (weakSelf.titleLabel.mas_bottom).with.offset (SCREEN_ORIGINWIDTH_5(0));
    ...
    [_timeLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.equalTo (weakSelf.introLabel.mas_bottom).with.offset (SCREEN_ORIGINWIDTH_5(0));
        make.width.offset (SCREEN_ORIGINWIDTH_5(300));
        make.height.equalTo (weakSelf.introLabel.mas_height).with.offset (0);
    }];
    
    [_seeLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.equalTo (weakSelf.timeLabel.mas_right).with.offset (SCREEN_ORIGINWIDTH_5(20));
        make.top.equalTo (weakSelf.timeLabel.mas_top).with.offset (0);
        make.width.offset (SCREEN_ORIGINWIDTH_5(200));
    ...
    [_photoImv mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.equalTo (weakSelf.backImV.mas_bottom).with.offset (SCREEN_ORIGINWIDTH_5(-90));
        make.width.offset (SCREEN_ORIGINWIDTH_5(80));
        make.height.offset (SCREEN_ORIGINWIDTH_5(80));
    }];
    
    [_nickLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.equalTo (weakSelf.photoImv.mas_right).with.offset (SCREEN_ORIGINWIDTH_5(10));
        make.top.equalTo (weakSelf.photoImv.mas_top).with.offset (0);
        make.right.equalTo (weakSelf.backImV.mas_right).with.offset (SCREEN_ORIGINWIDTH_5(-320));
        make.bottom.equalTo (weakSelf.photoImv.mas_bottom).with.offset (0);
    }];
    
    [_locationLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.equalTo (weakSelf.nickLabel.mas_right).with.offset (SCREEN_ORIGINWIDTH_5(10));

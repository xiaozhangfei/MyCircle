...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "LJWKeyboardHandler/LJWKeyboardHandlerExample/LJWKeyboardHandler/Resources.bundle"
  install_resource "MJRefresh/MJRefresh/MJRefresh.bundle"
  install_resource "RongCloudIMKitWithVoip/Rong_Cloud_iOS_IMKit_SDK_v2_6_2_dev_with_voip/RongCloud.bundle"
  install_resource "RongCloudIMKitWithVoip/Rong_Cloud_iOS_IMKit_SDK_v2_6_2_dev_with_voip/en.lproj"
  install_resource "RongCloudIMKitWithVoip/Rong_Cloud_iOS_IMKit_SDK_v2_6_2_dev_with_voip/zh-Hans.lproj"
  install_resource "RongCloudIMKitWithVoip/Rong_Cloud_iOS_IMKit_SDK_v2_6_2_dev_with_voip/Emoji.plist"
  install_resource "RongCloudIMKitWithVoip/Rong_Cloud_iOS_IMKit_SDK_v2_6_2_dev_with_voip/RCConfig.plist"
